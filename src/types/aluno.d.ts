...
export type Tab = 'Interação Avaliativa' | 'Interação Não Avaliativa' | 'Desempenho' | 'Profundidade Cognitiva' | 'Respostas em Fóruns' | 'Acesso à Disciplina' | 'Feedback'| 'Desistência';